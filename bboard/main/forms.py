...
from .models import AdvUser, SuperRubric, SubRubric, user_registrated, Bb, AdditionalImage, Comment
...
"""Веб-страницы регистрации нового пользователя"""
...
"""Инструменты для администрирования рубрик"""
...
"""Форма поиска и контроллер списка объявлений"""
class SearchForm(forms.Form):
    keyword = forms.CharField(required=False, max_length=20, label='')


"""Добаление нового объявления"""
